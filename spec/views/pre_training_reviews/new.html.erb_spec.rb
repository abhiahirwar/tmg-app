...
RSpec.describe "pre_training_reviews/new", type: :view do
  before(:each) do
    assign(:pre_training_review, PreTrainingReview.new(
      :rpl => "MyString",
  ...
  it "renders new pre_training_review form" do
    render

    assert_select "form[action=?][method=?]", pre_training_reviews_path, "post" do
