class Admin::CourseCategoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @course_category.save
        format.html { redirect_to [:admin, @course_category], notice: 'Course category was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @course_category.update(course_category_params)
        format.html { redirect_to [:admin, @course_category], notice: 'Course category was successfully updated.' }
  ...
  private
    ...
    def course_category_params
      params.require(:course_category).permit(:title, :content)
    end
end
